...
$.fn.easySlider = function(o) {
    ...
    return this.each(function() {                           // Returns the element collection. Chainable.
        ...
        var running = false, animCss=o.horizontal?"top":"left", sizeCss=o.horizontal?"height":"width";
        ...
        li.css({overflow: "hidden", float: o.horizontal ? "none" : "left"});
        ...
        function changeMainImage(url){
            $(o.mainImg).attr('data-zoom-image',url);
